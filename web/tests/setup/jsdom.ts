...
// auto-scroll-to-bottom chat log) throw "scrollTo is not a function" without
// this. A no-op is correct here: layout/scroll position isn't something a
// jsdom test can meaningfully assert on anyway.
