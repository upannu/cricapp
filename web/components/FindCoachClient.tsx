      ...
      <div className="flex flex-wrap items-center gap-2 mb-6">
        ...
        {searchCoords && (
          <button
            ...
            className="px-4 py-2.5 rounded-xl text-sm font-medium text-zinc-400 border border-zinc-700 hover:text-white hover:border-zinc-500 transition-colors cursor-pointer"
          >
            Clear
          </button>
        )}
