...
export async function POST(request: Request) {
  ...
  // (including one with no relationship to this player at all) falls straight through with no
  // check and can start a real subscription checkout for an arbitrary playerId. Matches the same
  // isStaff allow-list create-booking-checkout-session/create-pack-checkout-session already use.
