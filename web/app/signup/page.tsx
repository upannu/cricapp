    ...
    <div className="min-h-screen bg-ink flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-ink rounded-xl px-4 py-3 text-white placeholder-zinc-600 border focus:outline-none transition-colors ${
                  error
            ...
            <button
              type="submit"
              className="w-full bg-pace-green text-black font-bold py-3.5 rounded-xl hover:opacity-90 transition-opacity text-sm uppercase tracking-wider cursor-pointer mt-2"
            >
              Create Account
            </button>
          </form>
          ...
          {/* Terms */}
          <p className="text-center text-zinc-500 text-xs mt-5 leading-relaxed">
